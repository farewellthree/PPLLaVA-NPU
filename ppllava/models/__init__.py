...
def load_model(name, model_type, is_eval=False, device="cpu", checkpoint=None):
    ...
    return model.to(f'npu:{device}' if isinstance(device, int) else device)
...
def load_model_and_preprocess(name, model_type, is_eval=False, device="cpu"):
    ...
    return model.to(f'npu:{device}' if isinstance(device, int) else device), vis_processors, txt_processors
